...
TEST(Test_SmartCalc_v2, test_10) {
  s21::Model test;
...
TEST(Test_SmartCalc_v2, test_11) {
  s21::Model test;
  double x = 0.0003;
...
TEST(Test_SmartCalc_v2, test_12) {
  s21::Model test;
  double x = 0.0019;
...
TEST(Test_SmartCalc_v2, test_13) {
  s21::Model test;
  double x = 0.0019;
...
TEST(Test_SmartCalc_v2, test_14) {
  s21::Model test;
  double x = 0.004;
...
TEST(Test_SmartCalc_v2, test_15) {
  s21::Model test;
  double x = 25;
...
TEST(Test_SmartCalc_v2, test_16) {
  s21::Model test;
  double x = 2;
...
TEST(Test_SmartCalc_v2, test_17) {
  s21::Model test;
  double x = 2;
...
TEST(Test_SmartCalc_v2, test_18) {
  s21::Model test;
  string input = "()";
  double result = test.ScanLineEdit(input, 0);
  ASSERT_EQ(result, 0);
...
TEST(Test_SmartCalc_v2, test_19) {
  s21::Model test;
  string input = "3-(-3)";
  double result = test.ScanLineEdit(input, 0);
  ASSERT_EQ(result, 6);
...
TEST(Test_SmartCalc_v2, test_20) {
  s21::Model test;
  string input = "3-(+3)";
  double result = test.ScanLineEdit(input, 0);
  ASSERT_EQ(result, 0);
...
TEST(Test_SmartCalc_v2, test_21) {
  s21::Model test;
  string input = "2^2^3";
  double result = test.ScanLineEdit(input, 0);
...
TEST(Test_SmartCalc_v2, test_22) {
  s21::Model test;
...
TEST(Test_SmartCalc_v2, test_23) {
  s21::Model test;
...
TEST(Test_SmartCalc_v2, test_24) {
  s21::Model test;
